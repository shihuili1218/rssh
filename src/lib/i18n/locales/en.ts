...
const en = {
  ...
  "error.ssh_agent_and_default_failed": "SSH agent auth failed ({agent_code}); default private key auth also failed ({key_code})",
  ...
  "error.ssh_default_keys_unavailable": "All default private keys unavailable: {errors}",
  ...
  "error.import_partial_failed": "Partial import failed: {count} item(s) failed",
