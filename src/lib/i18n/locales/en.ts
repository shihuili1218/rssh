...
const en = {
  ...
  "ai.settings.shell_detect.desc": "When OFF (default), the remote is assumed POSIX (bash / zsh) — commands use `; echo \"...:$?\"`. Covers ~99% Linux / macOS remotes with zero overhead. When ON, opening the AI panel runs a one-line echo probe in the terminal to classify the remote as cmd.exe / PowerShell / POSIX, then picks the right sentinel template. Probe result is cached per profile for the rest of the process lifetime.",
