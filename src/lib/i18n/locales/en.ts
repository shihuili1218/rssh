...
const en = {
  ...
  "error.ssh_agent_and_default_failed": "SSH agent auth failed: {agent_err}; default private key auth also failed: {key_err}",
  ...
  "error.import_partial_failed": "Partial import failed: {errors}",
