...
const zh: Messages = {
  ...
  "error.ssh_agent_and_default_failed": "SSH agent 认证失败（{agent_code}）；默认私钥认证也失败（{key_code}）",
  ...
  "error.ssh_default_keys_unavailable": "所有默认私钥都不可用：{errors}",
  ...
  "error.import_partial_failed": "部分导入失败：{count} 项失败",
